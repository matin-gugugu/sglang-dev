...
def prediction_record(row, evaluation, fold, method, actual_calls, actual_bytes, predicted_calls, predicted_bytes, curves):
    ...
    return {
        ...
        "actual_calls_by_12bin_json": json.dumps(actual_calls.tolist(), separators=(",", ":")),
        "actual_bytes_by_12bin_json": json.dumps(actual_bytes.tolist(), separators=(",", ":")),
        "predicted_calls_by_12bin_json": json.dumps(predicted_calls.tolist(), separators=(",", ":")),
        "predicted_bytes_by_12bin_json": json.dumps(predicted_bytes.tolist(), separators=(",", ":")),
