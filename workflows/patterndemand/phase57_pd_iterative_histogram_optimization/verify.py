...
def verify(output: Path) -> dict:
    ...
    checks = {
        ...
        "candidate_budget": 0 < candidate_count <= 144 and candidate_count == len(trace) and candidate_count % 24 == 0,
        "round_count": 1 <= int(search["rounds_completed"]) <= 6 and int(search["candidate_budget"]) == candidate_count,
