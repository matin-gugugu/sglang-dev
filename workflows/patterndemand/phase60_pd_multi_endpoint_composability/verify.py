...
def verify(output:Path)->dict:
    ...
    checks={
      ...
      "resource_contract":summary.get("counts",{}).get("world_size_per_shard")==3 and summary.get("counts",{}).get("maximum_simultaneous_nodes_per_shard")==2 and summary.get("resource_contract",{}).get("four_inventory_slots_are_gpu_slots_not_nodes") is True and summary.get("resource_contract",{}).get("four_node_allocation_required") is False,
