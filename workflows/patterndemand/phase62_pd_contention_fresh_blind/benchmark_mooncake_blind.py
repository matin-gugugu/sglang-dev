#!/usr/bin/env python3
"""Execute the pinned Phase60 production benchmark with Phase62 blind contracts."""
...
def main() -> None:
    ...
    spec = importlib.util.spec_from_file_location("phase62_pinned_phase60_benchmark", P60_BENCHMARK)
