...
def main()->None:
 ...
 print(json.dumps({"status":"PASS","workflow_commit":head,"output":str(output),"plan_sha256":plan["plan_sha256"],"measurements":48,"resource_contract":{"maximum_simultaneous_nodes":2,"maximum_simultaneous_gpu_processes":5,"maximum_concurrent_shards":1,"four_node_required":False}},ensure_ascii=False,indent=2))
